...
import DisplayModeMixin from 'quasar-framework/src/mixins/display-mode.js'
...
import { clone, formatDate, isSameDate, isValid, startOfDate } from './date.js'
  ...
  computed: {
    ...
    computedValue () {
      ...
      if (process.env.THEME === 'ios') {
        return this.defaultValue || startOfDate(new PersianDate(), 'day')
      }
